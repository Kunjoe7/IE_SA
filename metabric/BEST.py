...
###############################################################################
df = pd.read_csv('/project/lwang/xqin5/SAcompare/metabric/metabric.csv')
data = df.copy()
...
train_indices, test_indices = train_test_split(
        range(len(data_sorted)), stratify=data_sorted['event'], random_state=1, test_size=0.2
    )
